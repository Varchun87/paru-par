...
const fallbackZones: Zone[] = [
  ...
  { name: 'Поляна песен', text: 'Место живой музыки, песен у костра и душевных встреч. Приходите слушать, подпевать, знакомиться и проживать самые тёплые вечера фестиваля.', image: '/media/photo/photo_2026-05-25_22-36-27.jpg' },
  ...
  { name: 'Телесные практики', text: 'Пространство мягкого восстановления, внимания к себе и глубокой перезагрузки. Вас ждут дыхательные практики, ладки, массажи, расслабление, работа с телом и бережные форматы, которые помогают снять напряжение.', image: '/media/photo/photo_2026-05-25_22-37-55.jpg' },
];
