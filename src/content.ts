...
const fallbackZones: Zone[] = [
  ...
  { name: 'Пляж', text: 'Это сердце фестиваля: коллективные и индивидуальные парения, авторские программы, выездные бани, банные палатки и настоящая атмосфера тепла. Лучшие пармастера, уникальные техники, ароматные веники - душевное пространство для перезагрузки.', image: '/media/photo/photo_2026-05-25_20-12-52.jpg' },
